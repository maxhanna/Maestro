    ...
    .factory('AgentMixin', ['$http', '$timeout', '$interval', '$window', function ($http, $timeout, $interval, $window) {
        ...
        return {
            init: function (vm, $scope) {
                ...
                vm.streamingContextSize = 0; vm.streamingSteps = []; vm.streamingFilesEdited = []; vm.streamingTestResult = null; vm.streamingTokenBuffer = '';
                                                        ...
                                                        switch (eventName) {
                                                            ...
                                                            case 'test_result':
                                                                if (parsed) {
                                                                    ...
                                                                    pushAgentLog(vm, parsed.passed ? 'info' : 'warn',

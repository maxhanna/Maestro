...
**Last audited:** August 15, 2026 · **Suite size:** 118 C# test classes
(1,974 runtime test cases per `dotnet test` on Windows) + 28 standalone JS suites
(293 tests), run together via `node tests/js/run-all.js`. The CI workflow builds
...
| File | Tests | What it covers |
|---|---|---|
| `agent-browser-tab.test.js` | 3 | The browser-test tab state: opening/closing the live-browser test report tab, its status chips, and the report panel wiring. |
